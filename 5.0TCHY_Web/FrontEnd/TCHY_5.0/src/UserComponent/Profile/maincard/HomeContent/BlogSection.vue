...
.content-area { flex: 1; min-width: 0; display: flex; flex-direction: column; padding-right: 20px; }
.section-header { display: flex; align-items: center; margin-bottom: 20px; padding-left: 5px; height: 30px; }
...
.blog-card { display: flex; background: rgba(255, 255, 255, 0.4); border: 1px solid #ddd; border-radius: 4px; padding: 15px; transition: all 0.3s ease; cursor: pointer; }
...
.blog-cover { width: 120px; height: 80px; background: rgba(249, 249, 249, 0.4); border-radius: 2px; display: flex; align-items: center; justify-content: center; margin-left: auto; overflow: hidden; }
.cover-img { width: 100%; height: 100%; object-fit: cover; }
.cover-placeholder { font-size: 10px; color: #ccc; font-weight: bold; }
.status-msg { text-align: center; padding: 30px; color: var(--text-sub); font-size: 13px; border: 1px dashed #ddd; }
